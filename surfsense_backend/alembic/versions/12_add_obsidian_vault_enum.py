"""Add OBSIDIAN_CONNECTOR to SearchSourceConnectorType and DocumentType enums
...
CONNECTOR_NEW_VALUE = "OBSIDIAN_CONNECTOR"
DOCUMENT_ENUM = "documenttype"
DOCUMENT_NEW_VALUE = "OBSIDIAN_CONNECTOR"


def upgrade() -> None:
    """Upgrade schema - add OBSIDIAN_CONNECTOR to connector and document enum."""
    # Add OBSIDIAN_CONNECTOR to searchsourceconnectortype
    op.execute(f"ALTER TYPE {CONNECTOR_ENUM} ADD VALUE '{CONNECTOR_NEW_VALUE}'")
    # Add OBSIDIAN_CONNECTOR to documenttype
    op.execute(f"ALTER TYPE {DOCUMENT_ENUM} ADD VALUE '{DOCUMENT_NEW_VALUE}'")


def downgrade() -> None:
    """Downgrade schema - remove OBSIDIAN_CONNECTOR from connector and document enum."""
